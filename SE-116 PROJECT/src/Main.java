...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       // args = new String[]{"4", "1sd", "points.txt","turtle","H", "mosquito", "R", "crocodile", "E", "camel", "N", "true"};
        ...
        try {
            ...
            for(int i=4;i<args.length-1;i++){
                if(!(args[i].equals("H")||args[i].equals("R")||args[i].equals("N")||args[i].equals("E"))){
                    System.out.println("please enter R, E, H or N");
                    System.exit(1);
                }
                i++;
            }
